...
interface ExpensesBetweenUsersData {
  expenses: Expense[];
...
export default function PersonExpensesPage(): React.JSX.Element {
  ...
  const otherUser: OtherUser = typedData?.otherUser || {
    id: params.id as string,
    name: "Unknown User",
    email: "unknown@example.com",
  };
  const expenses: Expense[] = typedData?.expenses || [];
  const settlements: Settlement[] = typedData?.settlements || [];
  const balance: number = typedData?.balance || 0;
    ...
    <div className="container mx-auto py-6 max-w-4xl">
      ...
      >
        ...
        <TabsContent value="expenses" className="space-y-4">
          {/* TODO: Create ExpenseList component */}
          <Card>
            <CardHeader>
